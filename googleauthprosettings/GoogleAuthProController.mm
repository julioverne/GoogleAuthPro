...
#define PLIST_PATH_Settings "/var/mobile/Library/Preferences/com.julioverne.appssiripin.plist"
#define PLIST_PATH_Settings_Apps "/var/mobile/Library/Preferences/com.julioverne.appssiripin.apps.plist"

@interface AppsSiriPinController : PSListController {
	UILabel* _label;
	UILabel* underLabel;
}
- (void)HeaderCell;
...
@implementation AppsSiriPinController
- (id)specifiers {
	if (!_specifiers) {
		...
		spec = [PSSpecifier preferenceSpecifierNamed:@"Pined Apps"
                                              target:self
                                                 set:NULL
                                                 get:NULL
                                              detail:Nil
		...
		if (access("/System/Library/PreferenceBundles/AppList.bundle", F_OK) == 0) {
			...
			[spec setProperty:@"com.julioverne.appssiripin/reloadSettings" forKey:@"ALChangeNotification"];
        ...
        [specifiers addObject:spec];
		spec = [PSSpecifier emptyGroupSpecifier];
        [spec setProperty:@"AppsSiriPin © 2018" forKey:@"footerText"];
        [specifiers addObject:spec];
...
- (void)love
{
	...
	[twitter setInitialText:@"#AppsSiriPin by @ijulioverne is cool!"];
	if (twitter != nil) {
...
- (void)reset
{
	...
	[[NSUserDefaults standardUserDefaults] removePersistentDomainForName:@"com.julioverne.appssiripin.apps"];
	[self reloadSpecifiers];
	notify_post("com.julioverne.appssiripin/reloadSettings");
}
...
- (void)HeaderCell
{
	...
	CGRect frame = CGRectMake(0, 20, width, 60);
		...
		[underLabel setText:@"Pin Apps In Siri Suggestion Widget"];
